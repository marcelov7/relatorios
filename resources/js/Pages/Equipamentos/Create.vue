...
const form = useForm({
    equipment_tag: '',
    nome: '',
    setor_id: '', // novo campo obrigatório
    tipo: '',
    marca: '',
    modelo: '',
    numero_serie: '',
...
const submit = () => {
    form.post(route('equipamentos.store'), {
        onSuccess: () => success('Equipamento cadastrado com sucesso!'),
        onError: () => error('Erro ao cadastrar equipamento. Verifique os campos obrigatórios.')
    })
}
</script> 